...
const dictionaries: Record<Locale, Record<string, string>> = {
  ja: {
    ...
    'dashboard.customSymbol.label': 'シンボル入力',
    'dashboard.customSymbol.placeholder': '例: AAPL',
    'dashboard.customSymbol.apply': '適用',
    'dashboard.metrics.expectedReturn': '年率期待リターン',
    'dashboard.metrics.volatility': '年間ボラティリティ',
    'dashboard.metrics.sharpe': 'シャープレシオ',
    'dashboard.assetSnapshot.title': '資産スナップショット',
    'dashboard.assetSnapshot.description': 'ポートフォリオ内での役割と主要指標を確認します。',
    'dashboard.assetSnapshot.assetName': '資産名',
    'dashboard.assetSnapshot.allocation': 'ポートフォリオ配分',
    'dashboard.assetSnapshot.ytd': '年初来リターン',
    'dashboard.status.calculating': '計算中…',
  ...
  en: {
    ...
    'nav.analysis': 'Advanced Analysis',
    ...
    'dashboard.customSymbol.label': 'Custom Symbol',
    'dashboard.customSymbol.placeholder': 'e.g., AAPL',
    'dashboard.customSymbol.apply': 'Apply',
    'dashboard.metrics.expectedReturn': 'Annual Expected Return',
    'dashboard.metrics.volatility': 'Annual Volatility',
    'dashboard.metrics.sharpe': 'Sharpe Ratio',
    'dashboard.assetSnapshot.title': 'Asset Snapshot',
    'dashboard.assetSnapshot.description':
      'Review the asset’s role in the portfolio along with its key metrics.',
    'dashboard.assetSnapshot.assetName': 'Asset Name',
    'dashboard.assetSnapshot.allocation': 'Portfolio Allocation',
    'dashboard.assetSnapshot.ytd': 'Year-to-Date Return',
    'dashboard.status.calculating': 'Calculating…',
